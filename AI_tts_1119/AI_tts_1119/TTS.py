...
# 文本输入框
text_input = st.text_area("输入您希望转为语音的文本", height=100, max_chars=400, placeholder="输入您希望转为语音的文本")
...
if st.button("生成语音"):
    ...
    if not text_input:
        ...
        # 显示生成中状态
        st.info("正在生成语音，请稍候...")
        endpoint_pre = os.getenv("ENTRY_URL","sgpu-niigan-tts-yous-zhouys-nim-sdnarfwfsu.cn-shanghai.fcapp.run:8089")
